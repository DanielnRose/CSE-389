...
public class BinSearchTree {
 ...
 public BTNode<Pair<Integer,String>>getRoot(){
	  return root;
  }
...
// a helper function for the delete operation  
 private BTNode<Pair<Integer,String>> findReplacement
  ...
  public  BTNode<Pair<Integer,String>> delete(BTNode<Pair<Integer,String>> root, BTNode<Pair<Integer,String>> aNode)
  {
    ...
    // find out which direction (left or right) to continue
      int ans = compare(aNode.getData(), (root.getData()));
      if (ans < 0) {  // apply recursion to the left subtree
       // fill in your code here
	   root.setLeft (delete(root.getLeft(), aNode));
      }
      else if (ans > 0) { // apply recursion to the right subtree 
        root.setRight (delete(root.getRight(), aNode));
      }
      else {
		 ...
		 root.setLeft(findReplacement(root.getLeft()));
		 root.setRight(delete(root.getRight(), aNode));
