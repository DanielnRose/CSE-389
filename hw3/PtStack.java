...
public class PtStack {
  ...
  public void reverse () {
	  ...
	  for (int i = 0; i < STACK_SIZE/2; i++){
		t = data[STACK_SIZE-i-1];
		data[STACK_SIZE-i-1] = data[i];
		data[i] = t;
	  }
