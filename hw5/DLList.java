...
public class DLList<T> extends AbstractSequentialList<T> {
 ...
 public static void main(String[] args) { 
   // test the use of iterators
   // create, lst, a list of Integers
...
// Test the use of iterators
   ...
   ListIterator<Integer> lstIt0 = lst.listIterator(0);
   while (lstIt0.hasNext()) {
     System.out.println(lstIt0.next());
   }
     
   ListIterator<Integer> lstIt1 = lst.listIterator(1);
   while (lstIt1.hasNext()) {
     System.out.println(lstIt1.next());
   } 
   
    ListIterator<Integer> lstIt2 = lst.listIterator(2);
    while (lstIt2.hasNext()) {
      System.out.println(lstIt2.next());
    }
 System.out.println("Show how to use insert at the beginning of the list");    
// Show how to use insert at the beginning of the list
    
    Integer i0 = new Integer(1);
    lst.add(1,i0);
     
   ListIterator<Integer> lstIt4 = lst.listIterator(0);
   while (lstIt4.hasNext()) {
     System.out.println(lstIt4.next());
   }
 }
}
